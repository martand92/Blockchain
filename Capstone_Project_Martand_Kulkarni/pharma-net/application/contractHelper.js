...
async function getContractInstance(org) {
	...
	// A CCP is defined manually in file connection-profile-{org}.yaml
	gateway = new Gateway();
	
	// A wallet is where the credentials to be used for this transaction exist
	// Credentials for user {Org}_ADMIN was initially added to this wallet.
	const wallet = new FileSystemWallet('./identity/org');
	
	// What is the username of this Client user accessing the network?
	const fabricUserName = org.toUpperCase()+'_ADMIN';
	...
	return channel.getContract('pharmanet','org.pharma-network.'+org);
}
